	...
	Class("ClassBrowser", {
		...
		methods: {
			...
			selectedClass: function (select) {
				...
				$('JooseCBBody').innerHTML = html
			},
			
			clearBody: function () {
				$('JooseCBBody').innerHTML = ""
			},
			...
			elementsSelect: function () {
				return $('JooseCBElementsSelect')
			},
			
			categoriesSelect: function () {
				return $('JooseCBCategoriesSelect')
			},
			
			classSelect: function () {
				return $('JooseCBClassesSelect')
			},
			
			moduleSelect: function () {
				return $('JooseCBModulesSelect')
			}
		}
	})
})